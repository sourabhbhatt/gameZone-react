...
const BottomSection = ({
  ...
  return (
    <div
    className={`relative w-full max-w-lg h-[17.25rem] p-4 sm:p-6 bg-transparent 
      bg-cover bg-center bg-no-repeat rounded-t-3xl z-10 ${
        disabled ? "opacity-60 pointer-events-none brightness-[40%]" : ""
      }`}
