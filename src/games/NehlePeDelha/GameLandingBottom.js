...
const GameLandingBottom = ({
  ...
  return (
    ...
    >
      <PlayAndEarnButton className="mt-5" />
      ...
      <div className="p-2 mt-4 justify-end">
        ...
        <div className="font-bold text-[14px] font-outfit underline text-white/80 mt-2 mb-3 ">
        ...
        <RangeSlider
          ...
          thumbColor={'#C09BFF'}
        />
        <div className="flex justify-between font-outfit text-[14px] font-regular items-center mb-4">
        ...
        >
          <span className="text-[16px] sm:text-lg font-outfit font-medium">Play With</span>
          <img
            src={images.coin}
            alt="Coin"
            className="w-4 sm:w-5 h-4 sm:h-5 object-contain animate-spin-slow"
          />
          <span className="text-[16px] font-outfit font-semibold">{formatINRLocale(currentFee)}</span>
        </button>
      </div>
    </div>
  );
