...
const Index = memo(() => {
  ...
  return (
    <div
      className="flex flex-col items-center justify-between h-screen w-screen text-white bg-cover bg-center bg-no-repeat bg-black"
      style={{
      ...
      <div className="flex-grow flex flex-col items-center justify-center w-full px-4">
        ...
        <main className="w-full max-w-lg mt-2">
          <section className="text-center px-4">
            ...
            <p className="text-sm text-gray-300 mt-2 font-outfit font-semibold">
          ...
          <div className="w-full h-[1px] bg-gradient-to-r from-green-200 via-green-600 to-green-200 my-4" />
