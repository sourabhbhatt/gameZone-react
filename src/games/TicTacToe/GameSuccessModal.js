      ...
      <div className="text-center mt-5 relative">
        ...
        <div className="flex justify-center items-center mt-6 space-x-8 relative z-10">
          <div className="flex flex-col items-center">
            <span className="text-4xl font-bold text-white">{winnerDetails?.playerScore}</span>
            <PlayerInfo
              name="You"
          ...
          <div className="flex flex-col items-center">
            <span className="text-4xl font-bold text-white">{winnerDetails?.botScore}</span>
