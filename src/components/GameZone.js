...
const GameZone = () => {
  const gameData = useMemo(
    () => [
      ...
      {
        title: "Play Patte pe Patta",
        description: " Patte pe Patta in this logic-based puzzle game.",
        imageSrc: fruitNinjaIcon,
        link: `/games/Patte-pe-Patta?token=${authData.token}&refreshToken=${authData.refreshToken}&userId=${authData.userId}`,
        bgColor: "bg-green-500",
      },
      // {
      //   title: "Teen Patti",
